  ...
  try {
    ...
    <div class="card" style="width: 24rem;">
      ...
      <div class="card-body">
        ...
        <div class="row my-4">
          <div class="col-4">
            <h5 class=" text-bg-secondary rounded-3 py-2 text-center">Repo's</h5>
            <p class="text-center fw-bolder fs-4">${public_repos}</p>
          </div>
          <div class="col-4">
            <h5 class=" text-bg-secondary rounded-3 py-2 text-center">Followers</h5>
            <p class="text-center fw-bolder fs-4">${followers}</p>
          </div>
          <div class="col-4">
            <h5 class=" text-bg-secondary rounded-3 py-2 text-center">Following</h5>
